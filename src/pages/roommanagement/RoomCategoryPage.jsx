...
//                    bg-gray-700 text-white !important transition-none !important animation-none"
//         required
...
//                    active:outline-none active:ring-0 active:border-blue-500
//                    focus-visible:outline-none focus-visible:ring-0 focus-visible:border-blue-500
//                    bg-gray-700 text-white resize-y !important transition-none !important animation-none"
...
//       capacity: category.capacity, // Send actual number, input converts
//       beds: category.beds,       // Send actual number, input converts
...
// --- Modal Component (move outside RoomCategoryPage to prevent remounts) ---
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5 sm:mb-6">
          <div className="relative">
            <input
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full border border-gray-300 rounded-lg pl-10 pr-3 py-2.5 text-base text-gray-900 placeholder-gray-400
