...
// Import React.memo
import { memo } from 'react'; // <--- Added this import
...
const RoomCategoryPage = () => {
    ...
    try {
      ...
      if (data && Array.isArray(data.categories)) {
        processedCategories = data.categories.map(cat => ({
            ...
            defaultPrice: typeof cat.defaultPrice === 'number' ? cat.defaultPrice : 0,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 p-2 sm:p-3 md:p-6 font-sans text-gray-800">
      ...
      <MemoizedModal // Use MemoizedModal
      ...
      {/* Image Gallery Modal */}
      <ImageGalleryModal // Also use the memoized version if defined globally
