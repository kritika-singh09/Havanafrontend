...
    try {
   
      const response = await axios.get(`${backendURL}/api/bookings/exportBookingsCSV`, { // Change endpoint if needed on backend
        responseType: 'blob', // Still important for binary data like XLSX
      });
...
      a.href = url;
      a.download = 'bookings.xlsx'; // Change filename to .xlsx
      
...
      let errorMessage = "Failed to download XLSX.";
      if (error.response) {
...
            <p className="text-gray-700 mb-6">Are you sure you want to delete this booking? This action cannot be undone.</p>
...
            
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                    <path fillRule="evenodd" d="M10.125 2.25A3.375 3.375 0 0 0 7.5 5.625v14.25a3.375 3.375 0 0 0 3.375 3.375h3.75a3.375 3.375 0 0 0 3.375-3.375V5.625A3.375 3.375 0 0 0 14.25 2.25h-3.75Zm-.53 4.544a.75.75 0 0 0-1.125-.972L7.373 6.993a.75.75 0 0 0 0 1.154l1.102 1.346a.75.75 0 0 0 1.125-.972l-.744-.91L10 6.643Zm5.602 1.353c-.02.404.148.813.447 1.112l1.102 1.346a.75.75 0 0 0 1.125-.972L17.587 6.993a.75.75 0 0 0-.173-.896l-.986-.807a.75.75 0 0 0-.85-.015.75.75 0 0 0-.096.096l-.745.91Z" clipRule="evenodd" />
                </svg>

              Download XLSX {/* Changed button text */}
            </button>
            <button
