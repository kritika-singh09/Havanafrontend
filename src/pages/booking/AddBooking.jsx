                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div className={inputGroupClass + " flex items-end gap-4"}>
                                <label htmlFor="fromCSV" className={checkboxLabelClass}>
                                    <input type="checkbox" name="fromCSV" id="fromCSV" checked={formData.fromCSV} onChange={handleChange} className="form-checkbox text-blue-600 rounded" />
                                    From CSV Import
                                </label>
                                <label htmlFor="epabx" className={checkboxLabelClass}>
                                    <input type="checkbox" name="epabx" id="epabx" checked={formData.epabx} onChange={handleChange} className="form-checkbox text-blue-600 rounded" />
                                    EPABX Enabled
                                </label>
                            </div>
                            <div className={inputGroupClass}>
